...
const Profiting = () => {
  return (
    <section className='w-full min-h-[970px] flex flex-col gap-[83px] pt-[120px] pb-[141px] px-[15px] lg:px-[50px] xl:px-[240px]'>
        {/* Top Section */}
        <section className='flex flex-col gap-[20px]'>
            <h2 className=' font-monument font-[400] text-[32px] xl:text-[68px] uppercase'>Profiting Through</h2>
            <h3 className=' font-monument font-[400] text-[24px] xl:text-[38px] leading-[120%] uppercase bg-gradient-to-r from-[#3D8BFF] to-[#AB23FF] text-transparent bg-clip-text self-end'>AI Innovation & Decentralization</h3>
        </section>
        {/* Bottom Section */}
